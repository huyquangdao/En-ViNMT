...
def parse_args():
    ...
    parser.add_argument('--drop_out', help = 'drop out prop', defalt = 0.1)
...
if __name__ == "__main__":
    ...
    lr_scheduler = optim.lr_scheduler.CyclicLR(optimizer = optimizer,base_lr=args.lr,max_lr=args.max_lr,step_size_up=2000)
