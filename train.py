...
def parse_args():
    ...
    parser.add_argument('--batch_size',help='Your training batch size',default=4, type = int)
    ...
    parser.add_argument('--val_batch_size', help='Your validation batch size', default=4)
